...
class MessageTemplate extends Right implements curdInterface
{
    /**
     * 特别说明
     * Common中的文件不能直接修改！！！！
    ...
    protected $modelName  = 'MessageTemplate';  //模型名,用于add和update方法
    protected $indexField = ['id','title','alert','updateTime'];  //查，字段名
    protected $addField   = ['title','alert'];    //增，字段名
    protected $editField  = ['title','alert'];   //改，字段名
    /**
